...
<!-- bootstrap 3.0.2 -->
<link href="/greencms/Public/AdminLTE/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
<!-- font Awesome -->
<link href="/greencms/Public/AdminLTE/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
<!-- Ionicons -->
<link href="/greencms/Public/AdminLTE/css/ionicons.min.css" rel="stylesheet" type="text/css"/>
<!-- Theme style -->
<link href="/greencms/Public/AdminLTE/css/AdminLTE.css" rel="stylesheet" type="text/css"/>
...
<!-- jQuery 2.0.2 -->
<!--<script type="text/javascript" src="/greencms/Public/share/js/jquery-2.0.2.min.js"></script>-->
<script type="text/javascript" src="/greencms/Public/share/js/jquery-1.9.0.min.js"></script>
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="/greencms/Public/baracktocat.jpg" class="img-circle" alt="User Image"/>
                                        </div>
                                        <h4>
                                            GreenCMS Team
                        ...
                        <div class="box-body">
                            ...
                            <div class="row-fluid">
								...
								<span style="font-size: 18px; color: red; font-weight: bold;"
                                      id="success"></span>
                                            <button type="button" class="btn btn-info" id='do_next'>
...
<!-- Bootstrap -->
<script src="/greencms/Public/AdminLTE/js/bootstrap.min.js" type="text/javascript"></script>
<!-- AdminLTE App -->
<script src="/greencms/Public/AdminLTE/js/AdminLTE/app.js" type="text/javascript"></script>

<!-- iCheck -->
<script src="/greencms/Public/AdminLTE/js/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
